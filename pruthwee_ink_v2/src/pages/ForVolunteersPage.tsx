...
function VolunteerHero() {
  return (
    <section className="relative pt-10 pb-24 md:pb-32 overflow-hidden">
      ...
      <div className="absolute top-0 left-1/3 w-96 h-96 bg-[#CCFF00]/5 rounded-full blur-3xl" />
            ...
            <div className="flex items-center gap-2 mt-8">
              <div className="flex -space-x-2">
                {['P', 'A', 'K', 'S', 'M'].map((l, i) => (
                  <div
                    key={i}
                    className="w-8 h-8 rounded-full bg-gradient-to-br from-[#CCFF00] to-[#888800] border-2 border-[#0C0C0C] flex items-center justify-center"
                  >
                    <span className="font-display font-black text-[#0C0C0C] text-xs">{l}</span>
                  </div>
                ))}
              </div>
              <p className="font-sans text-[#888888] text-sm">
                <span className="text-[#CCFF00] font-semibold">12,000+</span> volunteers already registered
              </p>
            </div>
          </motion.div>
            ...
            <div className="space-y-3">
              {STATUS_TIERS.slice(1, 5).map((tier, i) => (
                <motion.div
                  ...
                  className="flex items-center gap-4 bg-[rgba(20,20,20,0.5)] border rounded-xl px-5 py-4"
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <div className="font-sans text-[#888888] text-xs">{tier.perks[0]}</div>
                  </div>
                  <div className="font-display font-black text-[#CCFF00] text-sm">
                    {tier.hoursMin}h+
                  </div>
                </motion.div>
              ))}
              ...
              <div className="text-center">
                <span className="font-mono text-[#CCFF00] text-xs tracking-[2px]">+ 3 MORE TIERS ↓</span>
              </div>
            </div>
          </motion.div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-5 md:px-10">
        ...
        >
          <motion.div variants={fadeUp} className="text-center mb-14">
            ...
            >
              Benefits of{' '}
              <span className="text-[#CCFF00]">Volunteering</span>
            </h2>
          </motion.div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {BENEFITS.map((b) => (
              <motion.div
                ...
                className="bg-[rgba(12,12,12,0.5)] border border-[rgba(255,255,255,0.07)] rounded-2xl p-6 hover:border-[rgba(204,255,0,0.35)] transition-all duration-200 group"
              >
                <div className="w-12 h-12 rounded-xl bg-[rgba(255,255,255,0.06)] border border-[rgba(255,255,255,0.1)] flex items-center justify-center mb-4 group-hover:bg-[rgba(255,255,255,0.08)] transition-colors">
                  {b.icon}
                </div>
                ...
                <p className="font-sans text-[#888888] text-sm leading-relaxed">{b.desc}</p>
              </motion.div>
            ))}
          </div>
        </motion.div>
      ...
      <div className="max-w-7xl mx-auto px-5 md:px-10">
        ...
        >
          ...
          <div className="grid md:grid-cols-4 gap-6 md:gap-4 relative">
            ...
            <div className="hidden md:block absolute top-10 left-[12.5%] right-[12.5%] h-0.5 bg-gradient-to-r from-transparent via-[rgba(204,255,0,0.3)] to-transparent" />

            {HOW_IT_WORKS.map((step, i) => (
              <motion.div key={step.step} variants={fadeUp} className="relative text-center group">
                {/* Step circle */}
                <div className="relative w-20 h-20 mx-auto mb-5">
                  <div className="w-full h-full rounded-full bg-[rgba(20,20,20,0.8)] border-2 border-[rgba(255,255,255,0.12)] flex items-center justify-center group-hover:border-[#CCFF00] transition-all duration-200">
                    <span className="text-3xl">{step.icon}</span>
                  </div>
                  {/* Step number badge */}
                  <div className="absolute -top-1 -right-1 w-6 h-6 rounded-full bg-[#CCFF00] flex items-center justify-center">
                    <span className="font-display font-black text-[#0C0C0C] text-xs">{i + 1}</span>
                  </div>
                </div>

                <div className="font-mono text-[#CCFF00] text-[10px] tracking-[3px] uppercase mb-2">
                  Step {step.step}
                </div>
                <h3 className="heading-gradient font-display font-black text-[#F2F2F2] text-lg uppercase tracking-wide mb-3 group-hover:text-[#CCFF00] transition-colors">
                  {step.title}
                </h3>
      ...
      <div className="max-w-7xl mx-auto px-5 md:px-10">
        ...
        >
          <motion.div variants={fadeUp} className="text-center mb-14">
            ...
            >
              Your Journey to{' '}
              <span className="text-[#CCFF00]">Diamond</span>
            </h2>
          ...
          <motion.div variants={fadeUp} className="flex gap-3 overflow-x-auto pb-4 mb-8 justify-start md:justify-center">
            {STATUS_TIERS.map((tier) => (
              <button
                ...
                style={{
                  borderColor: active === tier.id ? tier.color : 'rgba(204,255,0,0.12)',
                  background:  active === tier.id ? `${tier.bgColor}` : 'rgba(12,12,12,0.4)',
                }}
              >
                <span className="text-2xl">{tier.icon}</span>
                <span
                  className="font-display font-black text-xs uppercase tracking-wider"
                  style={{ color: active === tier.id ? tier.color : '#888888' }}
                >
                  {tier.label}
                </span>
              </button>
          ...
          <motion.div
            ...
            className="max-w-2xl mx-auto bg-[rgba(12,12,12,0.6)] border-2 rounded-2xl p-8"
          ...
          >
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                <div className="font-mono text-[#CCFF00] text-sm">
                  {activeTier.id === 'none'
                    ? 'Starting level'
            ...
            <div className="mb-6">
              ...
              <div className="flex justify-between mt-1">
                <span className="font-mono text-[#CCFF00] text-[10px]">0h</span>
                <span className="font-mono text-[#CCFF00] text-[10px]">1000h+</span>
              </div>
            </div>

            <div>
              <p className="font-display font-bold text-[#888888] text-xs uppercase tracking-[2px] mb-3">
                Perks & Benefits
              </p>
              <ul className="space-y-2">
                {activeTier.perks.map((perk, i) => (
                  <li key={i} className="flex items-center gap-3">
                    ...
                    <span className="font-sans text-[#F2F2F2] text-sm">{perk}</span>
                  </li>
                ))}
              </ul>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-5 md:px-10">
        ...
        >
          <motion.div variants={fadeUp} className="text-center mb-12">
            ...
            >
              Skills & Causes{' '}
              <span className="text-[#CCFF00]">We Need</span>
            </h2>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-10">
            ...
            <motion.div variants={fadeUp}>
              <p className="font-display font-black text-[#CCFF00] text-sm uppercase tracking-[3px] mb-4">
                Skills We Look For
              </p>
              <div className="flex flex-wrap gap-2">
                {VOLUNTEER_SKILLS.map((skill) => (
                  <span
                    key={skill}
                    className="px-3 py-1.5 bg-[rgba(20,20,20,0.6)] border border-[rgba(255,255,255,0.1)] rounded-lg font-sans text-[#888888] text-sm hover:border-[#CCFF00] hover:text-[#CCFF00] transition-all duration-150 cursor-default"
                  >
                    {skill}
                  </span>
                ))}
            ...
            <motion.div variants={fadeUp}>
              ...
              <div className="flex flex-col gap-3">
                {CAUSES.map((cause) => (
                  <div
                    key={cause.id}
                    className="flex items-center gap-3 px-4 py-3 bg-[rgba(20,20,20,0.4)] border border-[rgba(255,255,255,0.07)] rounded-xl hover:border-[rgba(204,255,0,0.35)] transition-all duration-150"
                  >
        ...
        >
          ...
          <motion.div variants={fadeUp} className="space-y-3">
            {FAQ.map((item, i) => (
              <div
                key={i}
                className="bg-[rgba(12,12,12,0.5)] border border-[rgba(255,255,255,0.07)] rounded-xl overflow-hidden hover:border-[rgba(255,255,255,0.12)] transition-colors"
              >
                <button
                  onClick={() => setOpen(open === i ? null : i)}
                  className="w-full flex items-center justify-between gap-4 px-5 py-4 text-left"
                >
                  <span className="heading-gradient font-display font-black text-[#F2F2F2] text-base uppercase tracking-wide leading-tight">
                    {item.q}
                  </span>
                  <ChevronDown
                    size={18}
                    className={`text-[#CCFF00] flex-shrink-0 transition-transform duration-250 ${open === i ? 'rotate-180' : ''}`}
                  />
                </button>
                ...
                >
                  <div className="px-5 pb-5 border-t border-[rgba(204,255,0,0.1)]">
                    <p className="font-sans text-[#888888] text-sm leading-relaxed pt-4">
                      {item.a}
                    </p>
                  </div>
                </motion.div>
      ...
      <div className="max-w-7xl mx-auto px-5 md:px-10">
        ...
        >
          <motion.div variants={fadeUp}>
            ...
            >
              Privacy &{' '}
              <span className="text-[#CCFF00]">Control</span>
            </h2>
            <ul className="space-y-3">
              {points.map((pt, i) => (
                <li key={i} className="flex items-start gap-3">
                  <Shield size={16} className="text-[#CCFF00] flex-shrink-0 mt-0.5" />
                  <span className="font-sans text-[#888888] text-sm leading-relaxed">{pt}</span>
                </li>
              ))}
            </ul>
          </motion.div>
          ...
          <motion.div variants={fadeUp}>
            <div className="bg-[rgba(20,20,20,0.4)] border border-[rgba(255,255,255,0.08)] rounded-2xl p-8 text-center">
              <div className="text-6xl mb-4">🔒</div>
              <h3 className="heading-gradient font-display font-black text-[#F2F2F2] text-2xl uppercase tracking-wide mb-3">
                Data Never Sold
              </h3>
              <p className="font-sans text-[#888888] text-sm leading-relaxed mb-5">
...
function VolunteerCTASection() {
  ...
  return (
    <section className="py-20 bg-[#141414] border-t border-[rgba(255,255,255,0.07)]">
      <div className="max-w-3xl mx-auto px-5 md:px-10 text-center">
        ...
        {/* Newsletter mini */}
        <p className="font-display font-bold text-[#CCFF00] text-sm uppercase tracking-[2px] mb-4">
