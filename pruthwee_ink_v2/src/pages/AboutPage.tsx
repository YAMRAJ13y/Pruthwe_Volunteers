...
// ── DATA ──────────────────────────────────────
const TEAM = [
  { name: 'Pruthwee Founder',     title: 'Founder & Director',            letter: 'P', color: '#CCFF00' },
  { name: 'Programme Lead',       title: 'Head of Volunteer Programmes',  letter: 'P', color: '#CCFF00' },
...
function AboutHero() {
  return (
    <section className="relative pt-10 pb-20 overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#CCFF00]/4 rounded-full blur-3xl" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-5 md:px-10">
        ...
        >
          ...
          <p className="font-sans text-[#888888] text-lg leading-relaxed max-w-2xl">
        ...
        >
          {[
            ...
            <div key={s.label} className="bg-[rgba(20,20,20,0.5)] border border-[rgba(255,255,255,0.08)] rounded-2xl p-5 text-center">
              <div
                className="font-display font-black text-[#CCFF00] leading-none mb-1"
                style={{ fontSize: 'clamp(28px, 4vw, 48px)' }}
              >
                {s.num}
              </div>
              <div className="font-display font-bold text-[#CCFF00] text-xs uppercase tracking-[2px]">{s.label}</div>
            </div>
          ))}
        </motion.div>
      </div>
        ...
        >
          {[
            ...
            <motion.div
              key={item.label}
              variants={fadeUp}
              className="bg-[rgba(12,12,12,0.5)] border border-[rgba(255,255,255,0.07)] rounded-2xl p-8 hover:border-[rgba(255,255,255,0.15)] transition-all"
            >
              <div
              ...
              <p className="font-sans text-[#888888] text-base leading-relaxed">{item.text}</p>
            </motion.div>
          ))}
        </motion.div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-5 md:px-10">
        <SR>
          <div className="text-center mb-16">
            ...
            >
              From One River to{' '}
              <span className="text-[#CCFF00]">48 Cities</span>
            </h2>
          </div>
        </SR>
        ...
        <div className="relative">
          {/* Vertical line */}
          <div className="absolute left-0 md:left-1/2 top-0 bottom-0 w-px bg-gradient-to-b from-[#CCFF00] via-[rgba(204,255,0,0.3)] to-transparent ml-5 md:ml-0" />
              ...
              <SR key={item.year} delay={i * 0.05}>
                <div className={`relative flex items-start gap-6 md:gap-0 ${i % 2 === 0 ? 'md:flex-row' : 'md:flex-row-reverse'}`}>
                  ...
                  <div className={`flex-1 pl-12 md:pl-0 ${i % 2 === 0 ? 'md:pr-12 md:text-right' : 'md:pl-12'}`}>
                    <div
                      className="font-display font-black text-[#CCFF00] text-sm uppercase tracking-[3px] mb-1"
                    >
                      {item.year}
                    </div>
                  ...
                  {/* Centre dot */}
                  <div className="absolute left-3 md:left-1/2 md:-translate-x-1/2 top-1 w-4 h-4 rounded-full bg-[#CCFF00] border-4 border-[#0C0C0C] ring-2 ring-[rgba(204,255,0,0.3)]" />
      ...
      <div className="max-w-7xl mx-auto px-5 md:px-10">
        ...
        >
          <motion.div variants={fadeUp} className="text-center mb-14">
            ...
            >
              Our Core{' '}
              <span className="text-[#CCFF00]">Values</span>
            </h2>
          </motion.div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {VALUES.map((v) => (
              <motion.div
                ...
                className="bg-[rgba(12,12,12,0.5)] border border-[rgba(255,255,255,0.07)] rounded-2xl p-6 hover:border-[rgba(255,255,255,0.15)] transition-all group"
              >
                ...
                <p className="font-sans text-[#888888] text-sm leading-relaxed">{v.desc}</p>
              </motion.div>
            ))}
          </div>
        </motion.div>
      ...
      <div className="max-w-7xl mx-auto px-5 md:px-10">
        ...
        >
          <motion.div variants={fadeUp} className="text-center mb-14">
            ...
            >
              Our{' '}
              <span className="text-[#CCFF00]">Core Team</span>
            </h2>
          </motion.div>
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6">
            {TEAM.map((member) => (
              <motion.div
                key={member.name}
                variants={fadeUp}
                className="bg-[rgba(20,20,20,0.4)] border border-[rgba(255,255,255,0.07)] rounded-2xl p-6 flex items-center gap-5 hover:border-[rgba(255,255,255,0.15)] transition-all group"
              >
                <div
                ...
                <div>
                  ...
                  <div className="font-sans text-[#888888] text-xs mt-0.5">{member.title}</div>
                </div>
              </motion.div>
            ))}
          </div>
      ...
      <div className="max-w-7xl mx-auto px-5 md:px-10">
        ...
        >
          <motion.div variants={fadeUp} className="text-center mb-14">
            ...
            >
              Our{' '}
              <span className="text-[#CCFF00]">Partners</span>
            </h2>
          </motion.div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {PARTNER_LOGOS.map((p) => (
              <motion.div
                ...
                className="bg-[rgba(12,12,12,0.5)] border border-[rgba(255,255,255,0.07)] rounded-2xl p-6 hover:border-[rgba(255,255,255,0.15)] transition-all group"
              >
                <div className="font-display font-black text-[#CCFF00] text-xl uppercase tracking-wider mb-2 group-hover:text-[#F2F2F2] transition-colors">
                  {p.short}
                </div>
                <div className="font-sans text-[#888888] text-sm leading-snug">{p.name}</div>
              </motion.div>
            ))}
          </div>
        </motion.div>
        ...
        <SR>
          <div className="grid md:grid-cols-1 gap-12 items-center">
            <div>
              ...
              >
                Built for{' '}
                <span className="text-[#CCFF00]">India</span>
              </h2>
...
function AboutCTA() {
  return (
    <section className="py-20 bg-[#141414] border-t border-[rgba(204,255,0,0.1)]">
      <div className="max-w-3xl mx-auto px-5 md:px-10 text-center">
        <SR>
          ...
          >
            Join the{' '}
            <span className="text-[#CCFF00]">Movement</span>
          </h2>
