...
const CATEGORIES = [
  { id: 'all',         label: 'All Photos',  color: '#CCFF00' },
  ...
  { id: 'summit',      label: 'Summit',      color: '#CCFF00' },
];
...
export default function GalleryPage() {
  ...
  return (
    <div className="bg-[#0C0C0C] overflow-x-hidden" onKeyDown={handleKey} tabIndex={0}>
      ...
      <section className="relative pt-10 pb-16 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-5 md:px-10">
          <motion.div initial={{ opacity: 0, y: 28 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <p className="font-sans text-[#888888] text-lg max-w-xl">
          ...
          >
            {[
              ...
              <div key={s.label} className="flex items-center gap-2 bg-[rgba(20,20,20,0.5)] border border-[rgba(255,255,255,0.08)] rounded-xl px-4 py-2.5">
                <span className="font-display font-black text-[#CCFF00] text-xl">{s.num}</span>
                <span className="font-display font-bold text-[#CCFF00] text-xs uppercase tracking-[2px]">{s.label}</span>
              </div>
            ))}
          </motion.div>
        </div>
      ...
      {/* ── FILTERS ── */}
      <div className="sticky top-16 z-30 bg-[rgba(12,12,12,0.9)] backdrop-blur-md border-b border-[rgba(204,255,0,0.1)] py-4">
        <div className="max-w-7xl mx-auto px-5 md:px-10">
          <div className="flex flex-col sm:flex-row gap-3 items-start sm:items-center justify-between">
              ...
              {CATEGORIES.map(cat => (
                <button
                  ...
                  className={`flex-shrink-0 px-4 py-2 rounded-full border font-display font-bold text-xs uppercase tracking-wide transition-all duration-150 ${
                    category === cat.id
                      ? 'border-current'
                      : 'border-[rgba(255,255,255,0.08)] text-[#888888] hover:border-[#CCFF00] hover:text-[#CCFF00]'
                  }`}
            ...
            <div className="flex items-center gap-3 flex-shrink-0">
              <span className="font-mono text-[#CCFF00] text-xs tracking-wider">
                  ...
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-lg border font-display font-bold text-xs uppercase tracking-wide transition-all duration-150 ${
                      year === y
                        ...
                        : 'border-[rgba(255,255,255,0.07)] text-[#888888] hover:border-[#CCFF00]'
                    }`}
                  >
                    {y}
                  </button>
        ...
        <div className="max-w-7xl mx-auto px-5 md:px-10">
          ...
          {filtered.length === 0 ? (
            <div className="text-center py-20">
              ...
              <h3 className="heading-gradient font-display font-black text-[#F2F2F2] text-xl uppercase tracking-wide">
                No Photos Found
              </h3>
            </div>
          ) : (
              ...
              {filtered.map((photo, i) => (
                ...
                >
                  ...
                  >
                    ...
                    {/* Hover overlay */}
                    <div className="absolute inset-0 bg-gradient-to-t from-[#0C0C0C]/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-200 flex flex-col justify-between p-4">
                      <div className="flex justify-end">
                        <div className="w-8 h-8 rounded-full bg-[rgba(12,12,12,0.8)] flex items-center justify-center">
                          <ZoomIn size={14} className="text-[#CCFF00]" />
                        </div>
                      </div>
                      <div>
                        ...
                        <div className="font-mono text-[#CCFF00] text-[10px] mt-0.5 tracking-wider">
                    ...
                    <div
                      ...
                      style={{ background: CATEGORIES.find(c => c.id === photo.category)?.color ?? '#CCFF00' }}
                    />
                  </div>
                </motion.div>
              ))}
      ...
      <AnimatePresence>
        {lightbox !== null && filtered[lightbox] && (
          <motion.div
            ...
            className="fixed inset-0 z-[200] bg-[rgba(12,12,12,0.95)] backdrop-blur-sm flex items-center justify-center p-4"
            onClick={() => setLightbox(null)}
          >
            {/* Close */}
            <button
              onClick={() => setLightbox(null)}
              className="absolute top-5 right-5 w-10 h-10 rounded-full bg-[rgba(20,20,20,0.8)] border border-[rgba(255,255,255,0.1)] flex items-center justify-center text-[#888888] hover:text-[#F2F2F2] transition-colors z-10"
            >
              <X size={18} />
            </button>
            ...
            {lightbox > 0 && (
              <button
                ...
                className="absolute left-4 md:left-8 w-10 h-10 rounded-full bg-[rgba(20,20,20,0.8)] border border-[rgba(255,255,255,0.1)] flex items-center justify-center text-[#888888] hover:text-[#F2F2F2] transition-colors z-10"
              >
                <ChevronLeft size={20} />
              </button>
            )}
            ...
            {lightbox < filtered.length - 1 && (
              <button
                ...
                className="absolute right-4 md:right-8 w-10 h-10 rounded-full bg-[rgba(20,20,20,0.8)] border border-[rgba(255,255,255,0.1)] flex items-center justify-center text-[#888888] hover:text-[#F2F2F2] transition-colors z-10"
              >
            ...
            >
              ...
              <div className="flex items-start justify-between mt-4 px-2">
                <div>
                  <div className="heading-gradient font-display font-black text-[#F2F2F2] text-xl uppercase tracking-wide">
                    {filtered[lightbox].title}
                  </div>
                  <div className="font-sans text-[#888888] text-sm mt-1">
                    {filtered[lightbox].event} · {filtered[lightbox].city} · {filtered[lightbox].year}
                  </div>
                </div>
                <div className="flex gap-2 ml-4">
                  <button className="w-9 h-9 rounded-lg bg-[rgba(20,20,20,0.8)] border border-[rgba(255,255,255,0.1)] flex items-center justify-center text-[#888888] hover:text-[#CCFF00] transition-colors">
                    <Share2 size={15} />
                  </button>
                  <a
                    href={filtered[lightbox].url}
                    download
                    className="w-9 h-9 rounded-lg bg-[rgba(20,20,20,0.8)] border border-[rgba(255,255,255,0.1)] flex items-center justify-center text-[#888888] hover:text-[#CCFF00] transition-colors"
                  >
                    <Download size={15} />
                  </a>
                </div>
              ...
              <div className="text-center mt-3">
                <span className="font-mono text-[#CCFF00] text-xs tracking-[2px]">
