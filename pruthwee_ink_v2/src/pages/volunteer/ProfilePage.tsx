      ...
      <div className="max-w-5xl mx-auto px-4 md:px-8 py-8 space-y-6">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div>
              ...
              <h1 className="heading-gradient font-display font-black text-[#F2F2F2] uppercase leading-none"
                ...
                My <span className="text-[#CCFF00]">Profile</span>
              </h1>
            </div>
        ...
        <div className="grid lg:grid-cols-[260px_1fr] gap-6">
          ...
          <div className="space-y-5">
            <SR>
              {/* Avatar card */}
              <div className="bg-[rgba(20,20,20,0.4)] border border-[rgba(255,255,255,0.07)] rounded-2xl p-6 text-center">
                {/* Avatar */}
                <div className="relative inline-block mb-4">
                  <div className="w-24 h-24 rounded-full bg-gradient-to-br from-[#CCFF00] to-[#888800] flex items-center justify-center mx-auto">
                    <span className="font-display font-black text-[#0C0C0C] text-4xl">AP</span>
                  </div>
                  <button className="absolute bottom-0 right-0 w-7 h-7 rounded-full bg-[#141414] border border-[rgba(255,255,255,0.15)] flex items-center justify-center text-[#CCFF00] hover:text-[#CCFF00] transition-colors">
                    <Camera size={13} />
                  </button>
                </div>

                {/* Name + tier */}
                <h2 className="heading-gradient font-display font-black text-[#F2F2F2] text-lg uppercase tracking-wide mb-1">
                  {profile.firstName} {profile.lastName}
                </h2>
                <p className="font-sans text-[#888888] text-sm mb-3">{profile.city}</p>
                ...
                <div className="mt-4 pt-4 border-t border-[rgba(204,255,0,0.1)] text-left space-y-2">
                  {[
                    ...
                    <div key={item.label} className="flex justify-between">
                      <span className="font-display font-bold text-[#888888] text-[10px] uppercase tracking-wide">{item.label}</span>
                      <span className="font-sans text-[#F2F2F2] text-xs">{item.value}</span>
                    </div>
                  ))}
                </div>
              </div>
            ...
            <SR delay={0.08}>
              <div className="bg-[rgba(20,20,20,0.4)] border border-[rgba(255,255,255,0.07)] rounded-2xl p-5">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h3 className="font-display font-black text-[#CCFF00] text-xs uppercase tracking-[2px]">MQ Score</h3>
                  ...
                  {MQ_FACTORS.map(f => (
                    <div key={f.label}>
                      <div className="flex justify-between mb-0.5">
                        <span className="font-sans text-[#888888] text-[11px]">{f.label}</span>
                        <span className="font-mono text-[#CCFF00] text-[11px]">{f.score}/{f.max}</span>
                      </div>
                      <div className="h-1 bg-[rgba(255,255,255,0.06)] rounded-full">
                        <div className="h-full rounded-full bg-[#CCFF00]" style={{ width: `${(f.score / f.max) * 100}%` }} />
                      </div>
                    </div>
                  ))}
                </div>
          ...
          <SR delay={0.1}>
            <div className="bg-[rgba(20,20,20,0.4)] border border-[rgba(255,255,255,0.07)] rounded-2xl overflow-hidden">
              {/* Tab nav */}
              <div className="flex overflow-x-auto border-b border-[rgba(204,255,0,0.1)]">
                {SECTION_TABS.map(t => (
                  <button key={t.id} onClick={() => setTab(t.id)}
                    className={`flex-shrink-0 px-5 py-3.5 font-display font-bold text-xs uppercase tracking-wide transition-all border-b-2 ${
                      tab === t.id
                        ...
                        : 'text-[#888888] border-transparent hover:text-[#CCFF00]'
                    }`}>
                    {t.label}
                  </button>
                ))}
              ...
              <div className="p-6">
                <AnimatePresence mode="wait">
                  <motion.div key={tab}
                    ...
                    {tab === 'basic' && (
                      <div className="space-y-5">
                        ...
                        <div>
                          ...
                          <p className="font-sans text-[#CCFF00] text-[11px] mt-1">
                              ...
                              return (
                                <button key={lang} type="button"
                                  ...
                                  className={`px-3 py-1.5 rounded-full border font-display font-bold text-xs uppercase tracking-wide transition-all duration-150 ${
                                    active ? 'bg-[rgba(255,255,255,0.08)] border-[#CCFF00] text-[#CCFF00]' : 'border-[rgba(255,255,255,0.08)] text-[#888888] hover:border-[#CCFF00]'
                                  }`}>
                                  {lang}
                                </button>
                              );
                    ...
                    {tab === 'skills' && (
                      <div>
                        <p className="font-sans text-[#888888] text-sm mb-5 leading-relaxed">
                              ...
                              <button key={skill} type="button"
                                ...
                                className={`flex items-center gap-1.5 px-3 py-2 rounded-xl border font-display font-bold text-xs uppercase tracking-wide transition-all duration-150 ${
                                  active
                                    ...
                                    : 'border-[rgba(255,255,255,0.08)] text-[#888888] hover:border-[rgba(204,255,0,0.4)]'
                                }`}>
                        ...
                        <p className="font-sans text-[#CCFF00] text-xs mt-4">
                            ...
                            return (
                              <button key={cause.id} type="button"
                                ...
                                className={`flex items-center gap-3 p-4 rounded-xl border font-display font-bold text-xs uppercase tracking-wide transition-all duration-150 text-left ${
                                  active
                                    ? 'bg-[rgba(255,255,255,0.06)] border-[#CCFF00] text-[#CCFF00]'
                    ...
                    {tab === 'avail' && (
                      <div className="space-y-6">
                          ...
                          <div className="space-y-3">
                            {AVAILABILITY_TYPES.map(a => (
                              <button key={a.id} type="button"
                                ...
                                <div className={`w-4 h-4 rounded-full border-2 flex-shrink-0 mt-0.5 flex items-center justify-center ${profile.availability === a.id ? 'border-[#CCFF00]' : 'border-[rgba(255,255,255,0.15)]'}`}>
                                  {profile.availability === a.id && <div className="w-2 h-2 rounded-full bg-[#CCFF00]" />}
                                </div>
                                <div>
                                  <div className="heading-gradient font-display font-black text-[#F2F2F2] text-sm uppercase tracking-wide">{a.label}</div>
                                  <div className="font-sans text-[#888888] text-xs mt-0.5">{a.desc}</div>
                                </div>
                              </button>
                            ))}
                          </div>
                        ...
                        <div>
                          ...
                          <p className="font-sans text-[#CCFF00] text-[11px] mt-1">Private — only shared with event organisers of events you register for.</p>
                        </div>
                      </div>
                    )}
                    ...
                    {tab === 'prefs' && (
                      <div className="space-y-6">
                        <div>
                          <h3 className="heading-gradient font-display font-black text-[#F2F2F2] text-sm uppercase tracking-wide mb-4">Notification Preferences</h3>
                          <div className="space-y-3">
                            {([['email', 'Email'], ['sms', 'SMS'], ['whatsapp', 'WhatsApp']] as const).map(([key, label]) => (
                              <div key={key} className="flex items-center justify-between p-4 bg-[rgba(12,12,12,0.5)] rounded-xl border border-[rgba(204,255,0,0.1)]">
                                <div>
                                  <div className="font-display font-bold text-[#F2F2F2] text-sm uppercase tracking-wide">{label}</div>
                                  <div className="font-sans text-[#888888] text-xs">Event notifications, assignment updates</div>
                                </div>
                                <button
                                  onClick={() => update('notifications', { ...profile.notifications, [key]: !profile.notifications[key] })}
                                  className={`relative w-11 h-6 rounded-full transition-all duration-200 ${profile.notifications[key] ? 'bg-[#CCFF00]' : 'bg-[rgba(204,255,0,0.2)]'}`}>
                    ...
                    {tab === 'privacy' && (
                      <div className="space-y-5">
                        ...
                        {[
                          ...
                          <div key={item.key} className="flex items-center justify-between p-4 bg-[rgba(12,12,12,0.5)] rounded-xl border border-[rgba(204,255,0,0.1)]">
                            <div>
                              <div className="font-display font-bold text-[#F2F2F2] text-sm uppercase tracking-wide">{item.label}</div>
                              <div className="font-sans text-[#888888] text-xs">{item.desc}</div>
                            </div>
                            <button
                              onClick={() => update('visibility', { ...profile.visibility, [item.key]: !profile.visibility[item.key] })}
                              className={`relative w-11 h-6 rounded-full transition-all duration-200 ${profile.visibility[item.key] ? 'bg-[#CCFF00]' : 'bg-[rgba(204,255,0,0.2)]'}`}>
                        ...
                        <div className="pt-4 border-t border-[rgba(204,255,0,0.1)]">
              ...
              {/* Save button */}
              <div className="px-6 py-4 border-t border-[rgba(204,255,0,0.1)] flex justify-end">
                <button onClick={handleSave}
