...
export default function ContactPage() {
  ...
  const contactCards = [
    {
      icon: <Mail size={22} className="text-[#CCFF00]" />,
      label: 'General',
      value: CONTACT.email,
      href:  `mailto:${CONTACT.email}`,
    },
    {
      icon: <Phone size={22} className="text-[#CCFF00]" />,
      label: 'Phone',
      value: CONTACT.phone,
      href:  `tel:${CONTACT.phone}`,
    },
    {
      icon: <MapPin size={22} className="text-[#CCFF00]" />,
      label: 'Address',
            ...
            <SR>
              {submitted ? (
                <div className="bg-[rgba(110,224,122,0.06)] border border-[rgba(110,224,122,0.25)] rounded-2xl p-12 text-center h-full flex flex-col items-center justify-center">
                  ...
                  <p className="font-sans text-[#888888] text-base max-w-sm">
                ...
                <div className="bg-[rgba(20,20,20,0.4)] border border-[rgba(255,255,255,0.08)] rounded-2xl p-8">
                  <h2 className="heading-gradient font-display font-black text-[#F2F2F2] text-2xl uppercase tracking-wide mb-6">
                    Send Us a Message
                  </h2>
            ...
            <div className="space-y-5">
                ...
                <div className="space-y-3">
                  {contactCards.map((card) => (
                    <a
                      ...
                      className="flex items-start gap-4 bg-[rgba(20,20,20,0.4)] border border-[rgba(255,255,255,0.07)] rounded-xl p-5 hover:border-[rgba(204,255,0,0.35)] transition-all group"
                    >
                      <div className="w-10 h-10 rounded-lg bg-[rgba(255,255,255,0.06)] flex items-center justify-center flex-shrink-0 group-hover:bg-[rgba(255,255,255,0.08)] transition-colors">
                        {card.icon}
                      </div>
                      <div>
                        <div className="font-display font-bold text-[#CCFF00] text-xs uppercase tracking-[2px] mb-0.5">
                          {card.label}
                        </div>
                        <div className="font-sans text-[#F2F2F2] text-sm leading-snug group-hover:text-[#CCFF00] transition-colors">
                          {card.value}
                        </div>
                      </div>
                    </a>
              ...
              <SR delay={0.15}>
                <div className="bg-[rgba(20,20,20,0.4)] border border-[rgba(255,255,255,0.07)] rounded-xl p-5">
                  <h3 className="font-display font-black text-[#CCFF00] text-sm uppercase tracking-[2px] mb-4">
                    Department Contacts
                  </h3>
                  <div className="space-y-3">
                    {[
                      ...
                      <div key={d.dept} className="flex items-center justify-between">
                        ...
                        <a
                          href={`mailto:${d.email}`}
                          className="font-mono text-[#CCFF00] text-xs hover:text-[#CCFF00] transition-colors"
                        >
                          {d.email}
                        </a>
                      </div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {socialLinks.map((s) => (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center gap-3 px-3 py-2.5 rounded-lg border border-[rgba(255,255,255,0.07)] hover:border-[rgba(204,255,0,0.35)] transition-all group"
                      >
                        <span className="text-[#888888] group-hover:text-[#CCFF00] transition-colors">
                          {s.icon}
                        </span>
                        <span className="font-display font-bold text-[#888888] text-xs uppercase tracking-wide group-hover:text-[#CCFF00] transition-colors">
                          {s.label}
                        </span>
                      </a>
                    ))}
              ...
              {/* Office hours */}
              <SR delay={0.25}>
                <div className="bg-[rgba(204,255,0,0.05)] border border-[rgba(255,255,255,0.08)] rounded-xl p-5">
                  ...
                  <div className="space-y-1.5">
                    {[
                      ...
                      <div key={row.days} className="flex justify-between">
                        <span className="font-display font-bold text-[#888888] text-xs uppercase tracking-wide">{row.days}</span>
                        <span className="font-sans text-[#888888] text-xs">{row.time}</span>
                      </div>
                    ))}
                  </div>
                </div>
              ...
              {FAQ.map((item, i) => (
                ...
                >
                  ...
                  >
                    ...
                    <ChevronDown
                      size={18}
                      className={`text-[#CCFF00] flex-shrink-0 transition-transform duration-200 ${faqOpen === i ? 'rotate-180' : ''}`}
                    />
                  </button>
                  ...
                  >
                    <div className="px-5 pb-5 border-t border-[rgba(204,255,0,0.1)]">
                      <p className="font-sans text-[#888888] text-sm leading-relaxed pt-4">{item.a}</p>
                    </div>
                  </motion.div>
                </div>
              ))}
