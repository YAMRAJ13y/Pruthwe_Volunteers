...
const SPEAKERS = [
  { name: 'Dr. Anjali Mehta',    title: 'Director, Environmental Policy',  org: 'NITI Aayog',       letter: 'A', color: '#CCFF00' },
  { name: 'Rajesh Kumar IFS',    title: 'Additional Secretary',             org: 'Ministry of Environment', letter: 'R', color: '#CCFF00' },
...
const SESSION_COLORS: Record<string, { bg: string; text: string; border: string }> = {
  keynote:  { bg: 'rgba(204,255,0,0.08)',  text: '#CCFF00', border: 'rgba(204,255,0,0.25)' },
  panel:    { bg: 'rgba(204,255,0,0.08)',   text: '#CCFF00', border: 'rgba(204,255,0,0.25)'  },
...
function SummitHero({ countdown }: { countdown: ReturnType<typeof useCountdown> }) {
  return (
    <section className="relative min-h-[90vh] flex flex-col items-center justify-center overflow-hidden">
      ...
      {/* Radial glow blobs */}
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 w-[600px] h-[400px] bg-[#CCFF00]/6 rounded-full blur-3xl" />
      <div className="absolute bottom-0 left-0 w-80 h-80 bg-[#222200]/10 rounded-full blur-3xl" />
      <div className="absolute top-0 right-0 w-80 h-80 bg-[#CCFF00]/5 rounded-full blur-3xl" />

      {/* Horizontal accent lines */}
      <div className="absolute left-0 right-0 top-1/3 h-px bg-gradient-to-r from-transparent via-[rgba(204,255,0,0.15)] to-transparent" />
      <div className="absolute left-0 right-0 bottom-1/3 h-px bg-gradient-to-r from-transparent via-[rgba(204,255,0,0.1)] to-transparent" />
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-5 md:px-10 text-center">
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-2 px-5 py-2 rounded-full border border-[rgba(255,255,255,0.12)] bg-[rgba(255,255,255,0.04)] mb-8"
        >
        ...
        >
          <div
            className="font-display font-black text-[#CCFF00] uppercase tracking-[6px] mb-2"
          ...
          <h1
            className="font-display font-black text-transparent bg-clip-text bg-gradient-to-r from-[#CCFF00] via-[#CCFF00] to-[#CCFF00] uppercase leading-none -mt-2 md:-mt-4"
            style={{ fontSize: 'clamp(52px, 11vw, 130px)' }}
          >
            2026
          </h1>
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <span className="font-display font-black text-[#CCFF00] text-lg uppercase tracking-widest">
              12–13 April 2026
            </span>
          </div>
          <div className="w-1.5 h-1.5 rounded-full bg-[#CCFF00] hidden sm:block" />
          <div className="flex items-center gap-2">
        ...
        >
          {[
            ...
            <div key={l} className="flex items-center">
              {i > 0 && (
                <span className="font-display font-black text-[#1A1A1A] text-4xl md:text-6xl mx-1 md:mx-3">:</span>
              )}
              <div className="text-center min-w-[60px] md:min-w-[90px]">
                <div
                  className="heading-gradient font-display font-black text-[#F2F2F2] leading-none tabular-nums"
                  style={{ fontSize: 'clamp(44px, 8vw, 90px)' }}
                >
                  {String(v).padStart(2, '0')}
                </div>
                <div className="font-display font-bold text-[#CCFF00] text-xs uppercase tracking-[3px] mt-1">
                  {l}
                </div>
              </div>
            </div>
      ...
      >
        <ChevronDown size={22} className="text-[#CCFF00]" />
      </motion.div>
    </section>
  );
}
...
function AboutSection() {
  ...
  return (
    <section className="py-20 md:py-28 bg-[#141414] border-y border-[rgba(204,255,0,0.1)]">
      <div className="max-w-7xl mx-auto px-5 md:px-10">
        ...
        >
          <motion.div variants={fadeUp}>
            ...
            >
              India's Biggest{' '}
              <span className="text-[#CCFF00]">Volunteer Gathering</span>
            </h2>
          ...
          <motion.div variants={stagger} className="grid grid-cols-2 gap-4">
            {facts.map((f) => (
              <motion.div
                key={f.label}
                variants={fadeUp}
                className="bg-[rgba(12,12,12,0.5)] border border-[rgba(255,255,255,0.08)] rounded-2xl p-6 text-center hover:border-[rgba(204,255,0,0.35)] transition-all"
              >
                <div
                ...
                <div className="font-display font-bold text-[#CCFF00] text-xs uppercase tracking-[2px]">
                  {f.label}
                </div>
              </motion.div>
            ))}
...
function ProgrammeSection({
  ...
  return (
    <section id="programme" className="py-20 md:py-28 bg-[#0C0C0C]">
            ...
            return (
              ...
              >
                ...
                <div className="flex-1">
                  <div className="heading-gradient font-display font-black text-[#F2F2F2] text-sm uppercase tracking-wide leading-tight">
                    {session.title}
                  </div>
                  {session.venue && (
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6">
            {SPEAKERS.map((speaker) => (
              <motion.div
                ...
                className="bg-[rgba(12,12,12,0.5)] border border-[rgba(255,255,255,0.07)] rounded-2xl p-6 flex items-center gap-5 hover:border-[rgba(204,255,0,0.35)] transition-all group cursor-default"
              >
                {/* Avatar */}
                <div
                  className="w-14 h-14 rounded-full flex items-center justify-center flex-shrink-0 font-display font-black text-[#0C0C0C] text-2xl"
                  style={{ background: `linear-gradient(135deg, ${speaker.color}, ${speaker.color}99)` }}
                >
                  {speaker.letter}
                </div>
                <div>
                  <div className="heading-gradient font-display font-black text-[#F2F2F2] text-base uppercase tracking-wide group-hover:text-[#CCFF00] transition-colors">
                    {speaker.name}
                  </div>
                  <div className="font-sans text-[#888888] text-xs mt-0.5">{speaker.title}</div>
                  <div
        ...
        <SR>
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              >
                Community Solutions{' '}
                <span className="text-[#CCFF00]">Expo</span>
              </h2>
              <p className="font-sans text-[#888888] text-base leading-relaxed mb-4">
              ...
              <ul className="space-y-2">
                {[
                  ...
                  <li key={item} className="flex items-center gap-3 font-sans text-[#888888] text-sm">
                    <CheckCircle size={14} className="text-[#CCFF00] flex-shrink-0" /> {item}
                  </li>
                ))}
              </ul>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-[rgba(20,20,20,0.4)] border border-[rgba(255,255,255,0.07)] rounded-2xl p-5 aspect-square flex flex-col items-center justify-center text-center hover:border-[rgba(255,255,255,0.15)] transition-all">
                <div className="font-display font-black text-[#CCFF00] text-5xl leading-none mb-2">20+</div>
                <div className="font-display font-bold text-[#CCFF00] text-xs uppercase tracking-[2px]">NGO Exhibitors</div>
              </div>
              <div className="bg-[rgba(20,20,20,0.4)] border border-[rgba(255,255,255,0.07)] rounded-2xl p-5 aspect-square flex flex-col items-center justify-center text-center hover:border-[rgba(255,255,255,0.15)] transition-all">
                <div className="font-display font-black text-[#CCFF00] text-5xl leading-none mb-2">2</div>
                <div className="font-display font-bold text-[#CCFF00] text-xs uppercase tracking-[2px]">Full Days</div>
              </div>
              <div className="col-span-2 bg-[rgba(255,255,255,0.04)] border border-[rgba(255,255,255,0.08)] rounded-2xl p-5 text-center hover:border-[rgba(255,255,255,0.15)] transition-all">
                <div className="font-display font-black text-[#CCFF00] text-3xl leading-none mb-1">Free Entry</div>
                <div className="font-sans text-[#888888] text-sm">Expo open to all summit attendees</div>
              </div>
            </div>
          </div>
        </SR>
        ...
        <SR>
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              >
                Mahatma Mandir{' '}
                <span className="text-[#CCFF00]">Gandhinagar</span>
              </h2>
              <p className="font-sans text-[#888888] text-base leading-relaxed mb-6">
              ...
              <div className="space-y-3 mb-6">
                {[
                  { icon: <MapPin size={15} className="text-[#CCFF00]" />, text: 'Sector 13, Gandhinagar — 382016, Gujarat' },
                  { icon: <Calendar size={15} className="text-[#CCFF00]" />, text: '12–13 April 2026' },
                  { icon: <Users size={15} className="text-[#CCFF00]" />, text: 'Capacity: 2,000 · Summit expects 500+' },
                ].map((item, i) => (
                  <div key={i} className="flex items-center gap-3">
                    {item.icon}
                    <span className="font-sans text-[#888888] text-sm">{item.text}</span>
                  </div>
                ))}
              </div>
              <a
            ...
            {/* Map placeholder */}
            <div className="bg-[rgba(12,12,12,0.5)] border border-[rgba(255,255,255,0.07)] rounded-2xl h-72 flex items-center justify-center">
              <div className="text-center">
                <MapPin size={36} className="text-[#CCFF00] mx-auto mb-3" />
                <div className="heading-gradient font-display font-black text-[#F2F2F2] text-lg uppercase tracking-wide">
                  Mahatma Mandir
                </div>
                <div className="font-sans text-[#888888] text-sm mt-1">Gandhinagar, Gujarat</div>
                <a
                  href="https://maps.google.com/?q=Mahatma+Mandir+Gandhinagar"
                  target="_blank"
                  rel="noopener noreferrer"
...
function RegistrationSection({
  ...
  return (
    <section id="register" className="py-20 md:py-28 bg-[#0C0C0C]">
      <div className="max-w-4xl mx-auto px-5 md:px-10">
        <SR>
          <div className="text-center mb-12">
            ...
            >
              Register for{' '}
              <span className="text-[#CCFF00]">Summit 2026</span>
            </h2>
          </div>
        </SR>
            ...
            {REGISTRATION_CATEGORIES.map(cat => (
              <button
                ...
                className={`rounded-xl p-4 border text-center transition-all duration-200 ${
                  regCategory === cat.id
                    ? 'bg-[rgba(255,255,255,0.07)] border-[#CCFF00]'
                    : 'border-[rgba(255,255,255,0.07)] hover:border-[rgba(204,255,0,0.35)]'
                } ${cat.highlight ? 'ring-1 ring-[#CCFF00]' : ''}`}
              >
                <div className={`font-display font-black text-lg uppercase tracking-wide ${regCategory === cat.id ? 'text-[#CCFF00]' : 'text-[#F2F2F2]'}`}>
                  {cat.label}
                </div>
                <div className={`font-display font-black text-sm mt-1 ${regCategory === cat.id ? 'text-[#CCFF00]' : 'text-[#888888]'}`}>
                  {cat.price}
                </div>
                {cat.highlight && (
        ...
        <SR delay={0.15}>
          <div className="bg-[rgba(20,20,20,0.4)] border border-[rgba(255,255,255,0.07)] rounded-xl p-4 mb-8">
            <p className="font-sans text-[#888888] text-sm mb-3">{activeCat.desc}</p>
            <div className="flex flex-wrap gap-2">
        ...
        {submitted ? (
          ...
          <SR delay={0.2}>
            <form
              ...
              className="bg-[rgba(20,20,20,0.4)] border border-[rgba(255,255,255,0.07)] rounded-2xl p-8 space-y-5"
            >
    ...
    <section className="py-16 bg-[#141414] border-t border-[rgba(204,255,0,0.1)]">
      <div className="max-w-5xl mx-auto px-5 md:px-10 text-center">
        <SR>
          ...
          <h2
            className="heading-gradient font-display font-black text-[#F2F2F2] uppercase leading-none mb-12"
            style={{ fontSize: 'clamp(28px, 4vw, 48px)' }}
          >
            Summit{' '}
            <span className="text-[#CCFF00]">Supporters</span>
          </h2>
              ...
              <div key={tier.label}>
                ...
                <div className="flex flex-wrap items-center justify-center gap-4 md:gap-8">
                  {tier.sponsors.map(s => (
                    <span
                      key={s}
                      className="font-display font-bold text-[#888888] uppercase tracking-wider hover:text-[#CCFF00] transition-colors cursor-default"
