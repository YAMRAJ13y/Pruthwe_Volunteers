  ...
  return (
    <div className="bg-[#0C0C0C] overflow-x-hidden">
      ...
      <section className="relative pt-10 pb-20 overflow-hidden">
        ...
        <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#CCFF00]/5 rounded-full blur-3xl pointer-events-none" />
        <div className="relative z-10 max-w-7xl mx-auto px-5 md:px-10">
          <motion.div initial={{ opacity: 0, y: 28 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.65 }}>
            ...
            <p className="font-sans text-[#888888] text-lg max-w-xl leading-relaxed">
          ...
          <motion.div
            ...
            className="mt-10 py-4 border-y border-[rgba(255,255,255,0.07)] overflow-hidden"
          >
            <div className="marquee-track gap-12">
              {[...PARTNER_LOGOS, ...PARTNER_LOGOS].map((p, i) => (
                <span key={i} className="font-display font-black text-[#888888] text-sm tracking-[3px] uppercase px-8 hover:text-[#CCFF00] transition-colors cursor-default whitespace-nowrap">
                  {p.short}
                </span>
              ))}
            </div>
          ...
          <SR>
            <div className="mb-12">
              ...
              <h2 className="heading-gradient font-display font-black text-[#F2F2F2] uppercase leading-none"
                ...
                National <span className="text-[#CCFF00]">Recognition</span>
              </h2>
            </div>
          </SR>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {GOVT_PARTNERS.map((p, i) => (
              <SR key={p.short} delay={i * 0.08}>
                <div className="h-full bg-[rgba(12,12,12,0.5)] border border-[rgba(255,255,255,0.07)] rounded-2xl p-7 hover:border-[rgba(204,255,0,0.35)] transition-all group">
                  <div className="flex items-start justify-between mb-4">
                    <div>
                      ...
                      <div className="font-sans text-[#888888] text-xs leading-snug max-w-xs">{p.name}</div>
                    </div>
                    <div className="flex flex-col items-end gap-2 flex-shrink-0 ml-4">
                      <span className="badge badge-teal">{p.tier} Partner</span>
                      <span className="font-mono text-[#CCFF00] text-[10px] tracking-wider">Since {p.since}</span>
                    </div>
                  </div>
                  <div className="font-display font-bold text-xs uppercase tracking-[2px] mb-3" style={{ color: p.color }}>
                    {p.role}
                  </div>
                  <p className="font-sans text-[#888888] text-sm leading-relaxed">{p.desc}</p>
        ...
        <div className="max-w-7xl mx-auto px-5 md:px-10">
          <SR>
            <div className="mb-12">
              ...
              <h2 className="heading-gradient font-display font-black text-[#F2F2F2] uppercase leading-none"
                style={{ fontSize: 'clamp(32px, 5vw, 60px)' }}>
                On-Ground <span className="text-[#CCFF00]">Partners</span>
              </h2>
            </div>
          </SR>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {CIVIL_PARTNERS.map((p, i) => (
              <SR key={p.short} delay={i * 0.07}>
                <div className="h-full bg-[rgba(20,20,20,0.4)] border border-[rgba(255,255,255,0.07)] rounded-2xl p-6 hover:border-[rgba(255,255,255,0.15)] transition-all group">
                  <div className="flex items-start justify-between mb-3">
                    <div className="font-display font-black text-xl uppercase tracking-wide group-hover:text-[#CCFF00] transition-colors"
                      style={{ color: p.color }}>
                      {p.short}
                    </div>
                    <span className="font-mono text-[#CCFF00] text-[9px] tracking-[2px] uppercase border border-[rgba(255,255,255,0.1)] px-2 py-0.5 rounded">
                      {p.type}
                    </span>
                  </div>
                  <div className="font-sans text-[#888888] text-xs mb-2">{p.name}</div>
          ...
          <SR>
            <div className="text-center mb-14">
              ...
              <h2 className="heading-gradient font-display font-black text-[#F2F2F2] uppercase leading-none"
                ...
                What Partnership <span className="text-[#CCFF00]">Delivers</span>
              </h2>
            </div>
          </SR>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-5">
            {[
              ...
              <SR key={s.label} delay={i * 0.08}>
                <div className="bg-[rgba(12,12,12,0.5)] border border-[rgba(255,255,255,0.07)] rounded-2xl p-6 text-center hover:border-[rgba(255,255,255,0.15)] transition-all">
                  <div className="font-display font-black text-[#CCFF00] leading-none mb-2"
        ...
        <div className="max-w-7xl mx-auto px-5 md:px-10">
          <SR>
            <div className="text-center mb-12">
              ...
              <h2 className="heading-gradient font-display font-black text-[#F2F2F2] uppercase leading-none mb-4"
                style={{ fontSize: 'clamp(32px, 5vw, 60px)' }}>
                Become a <span className="text-[#CCFF00]">Partner</span>
              </h2>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-10">
            {BECOME_PARTNER_TYPES.map((t, i) => (
              <SR key={t.title} delay={i * 0.07}>
                <div className="bg-[rgba(20,20,20,0.4)] border border-[rgba(255,255,255,0.07)] rounded-2xl p-6 hover:border-[rgba(255,255,255,0.15)] transition-all text-center group">
                  ...
                  <p className="font-sans text-[#888888] text-sm leading-relaxed">{t.desc}</p>
                </div>
              </SR>
            ))}
          </div>
