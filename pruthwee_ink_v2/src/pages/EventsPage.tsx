...
export default function EventsPage() {
  ...
  return (
    <div className="bg-[#0C0C0C] min-h-screen">
      ...
      {/* ── HERO HEADER ── */}
      <section className="relative pt-8 pb-12 border-b border-[rgba(204,255,0,0.1)] overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-5 md:px-10">
          ...
          >
            ...
            >
              Find Your{' '}
              <span className="text-[#CCFF00]">Event</span>
            </h1>
            <p className="font-sans text-[#888888] text-base max-w-lg">
          ...
          >
            ...
            <div className="relative flex-1">
              <Search size={17} className="absolute left-4 top-1/2 -translate-y-1/2 text-[#CCFF00]" />
              <input
                type="text"
                value={search}
              ...
              />
              {search && (
                <button onClick={() => setSearch('')} className="absolute right-3 top-1/2 -translate-y-1/2 text-[#CCFF00] hover:text-[#CCFF00]">
                  <X size={15} />
                </button>
              )}
            </div>
            ...
            <div className="relative">
              <MapPin size={15} className="absolute left-3 top-1/2 -translate-y-1/2 text-[#CCFF00]" />
              <select
                value={city}
              ...
              <ChevronDown size={14} className="absolute right-3 top-1/2 -translate-y-1/2 text-[#CCFF00] pointer-events-none" />
            </div>
            ...
            <button
              ...
              className={`
                ...
                ${showFilters || activeFilters > 0
                  ...
                  : 'border-[rgba(255,255,255,0.1)] text-[#888888] hover:border-[#CCFF00] hover:text-[#CCFF00]'
                }
              `}
            >
              ...
              Filters
              {activeFilters > 0 && (
                <span className="w-5 h-5 rounded-full bg-[#CCFF00] text-[#0C0C0C] font-black text-xs flex items-center justify-center">
                  {activeFilters}
                </span>
              )}
            </button>
      ...
      <div className="max-w-7xl mx-auto px-5 md:px-10 py-12">
        ...
        {!search && !city && !category && (
          ...
          >
            <div className="flex items-center gap-2 mb-5">
              ...
              <span className="font-display font-black text-[#CCFF00] text-sm uppercase tracking-[3px]">
                Featured Events
              </span>
            </div>
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            <h2 className="heading-gradient font-display font-black text-[#F2F2F2] text-xl uppercase tracking-wide">
  ...
  return (
    ...
    >
      <Link to={`/events/${ev.id}`} className="block group">
        <div className="relative rounded-2xl overflow-hidden border border-[rgba(255,255,255,0.1)] hover:border-[rgba(255,255,255,0.25)] transition-all duration-250 hover:-translate-y-1.5 hover:shadow-glow">
          {/* Image */}
          ...
          <div className="bg-[#141414] p-5">
            <div className="font-mono text-[#CCFF00] text-[10px] tracking-[2px] uppercase mb-1">
              {ev.org}
            </div>
            <h3 className="heading-gradient font-display font-black text-[#F2F2F2] text-lg uppercase tracking-wide leading-tight mb-3 group-hover:text-[#CCFF00] transition-colors">
              {ev.title}
            </h3>
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="flex items-center gap-1.5 text-[#888888] text-xs font-sans">
  ...
  return (
    <motion.div variants={fadeUp}>
      <Link to={`/events/${ev.id}`} className="block group h-full">
        <div className="h-full flex flex-col bg-[#141414] border border-[rgba(255,255,255,0.07)] rounded-2xl overflow-hidden hover:border-[rgba(255,255,255,0.18)] hover:-translate-y-1.5 transition-all duration-250 hover:shadow-card">
          ...
          <div className="relative h-44 overflow-hidden flex-shrink-0">
            ...
            {/* Full */}
            {ev.seats === 0 && (
              <div className="absolute inset-0 bg-[rgba(12,12,12,0.7)] flex items-center justify-center">
          ...
          <div className="flex-1 flex flex-col p-5">
            <div className="font-mono text-[#CCFF00] text-[9px] tracking-[2px] uppercase mb-1">{ev.org}</div>
            <h3 className="heading-gradient font-display font-black text-[#F2F2F2] text-base uppercase tracking-wide leading-tight mb-3 group-hover:text-[#CCFF00] transition-colors flex-1">
              {ev.title}
            </h3>
            ...
            <div className="flex items-center gap-3 mb-3">
              <div className="flex items-center gap-1.5 text-[#888888] text-xs font-sans">
                <MapPin size={11} className="text-[#CCFF00]" /> {ev.city}
              </div>
              <div className="flex items-center gap-1.5 text-[#888888] text-xs font-sans">
                <Calendar size={11} className="text-[#CCFF00]" /> {ev.date}
              </div>
            </div>
            ...
            <div className="mb-3">
              <div className="flex justify-between mb-1">
                <span className="font-display font-bold text-[#888888] text-[10px] uppercase tracking-wide">
                  {fillPct}% filled
                </span>
              ...
              <div className="h-1.5 bg-[rgba(255,255,255,0.06)] rounded-full overflow-hidden">
                <div
                  ...
                  style={{
                    width: `${fillPct}%`,
                    background: fillPct > 85 ? '#FCA5A5' : fillPct > 60 ? '#FCD34D' : '#CCFF00',
                  }}
                />
              </div>
            </div>
            ...
            {/* Register button */}
            <div className="flex items-center justify-between pt-3 border-t border-[rgba(204,255,0,0.1)]">
              <span className="font-sans text-[#CCFF00] text-xs">
                {ev.seats === 0 ? 'Waitlist available' : 'Registration open'}
              </span>
              <span className="flex items-center gap-1 font-display font-bold text-[#CCFF00] text-xs uppercase tracking-wide group-hover:gap-2 transition-all">
...
function EmptyState({ onClear }: { onClear: () => void }) {
  return (
    <div className="text-center py-20">
      ...
      <h3 className="heading-gradient font-display font-black text-[#F2F2F2] text-2xl uppercase tracking-wide mb-2">
        No Events Found
      </h3>
