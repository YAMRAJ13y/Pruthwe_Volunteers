...
import {
  ...
  User, FolderKanban, PlusCircle, Shield, LogOut,
} from 'lucide-react';
      ...
      >
        <div className="w-full px-5 md:px-10">
          <div className="flex items-center justify-between h-16 md:h-[68px]">
            ...
            {/* ── LOGO ── */}
            <Link to="/" className="flex items-center gap-2.5 group" aria-label="Pruthwee volunteers home">
              <div className="w-8 h-8 rounded-[6px] bg-[#CCFF00] flex items-center justify-center group-hover:scale-105 transition-transform duration-200">
                <span className="text-[#0C0C0C] font-display font-black text-sm leading-none">P</span>
              </div>
              <div className="flex flex-col leading-none">
                <span className="font-display font-bold text-[#F2F2F2] text-sm tracking-wide">PRUTHWEE</span>
                <span className="font-mono text-[#555] text-[9px] tracking-[3px] uppercase">Volunteers</span>
              </div>
            </Link>
