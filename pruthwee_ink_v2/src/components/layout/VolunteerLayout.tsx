  ...
  return (
    <div className="flex min-h-[calc(100vh-4rem)] bg-[#0C0C0C]">
      ...
      {/* ══════════════════════════════════════
          DESKTOP SIDEBAR (≥ lg)
      ══════════════════════════════════════ */}
      <aside className="hidden lg:flex flex-col w-56 xl:w-60 flex-shrink-0 bg-[#02294D] border-r border-[rgba(204,255,0,0.1)] sticky top-16 h-[calc(100vh-4rem)] overflow-y-auto">
      ...
      <div className="flex-1 min-w-0 flex flex-col">
        ...
        <div className="lg:hidden flex items-center gap-3 px-4 py-3 bg-[#02294D] border-b border-[rgba(204,255,0,0.1)]">
          <div
      ...
      ══════════════════════════════════════ */}
      <nav className="lg:hidden fixed bottom-0 left-0 right-0 z-40 bg-[#02294D]/95 backdrop-blur-md border-t border-[rgba(255,255,255,0.08)] safe-area-pb">
