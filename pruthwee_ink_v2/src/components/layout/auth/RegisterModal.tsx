...
function RoleCard({
  ...
  return (
    <button
      ...
      className={`relative text-left p-5 rounded-2xl border-2 transition-all duration-200 w-full ${
        selected
          ...
          : 'border-[rgba(255,255,255,0.08)] bg-[rgba(12,12,12,0.4)] hover:border-[rgba(255,255,255,0.15)]'
      }`}
    ...
    >
      ...
      <p className="heading-gradient font-display font-black text-[#F2F2F2] text-base uppercase tracking-wide leading-none mb-1">
        {title}
      </p>
      <p className="font-sans text-[#888888] text-xs leading-snug mb-3">{desc}</p>
      <ul className="space-y-1">
        {features.map(f => (
          <li key={f} className="flex items-center gap-1.5 font-sans text-[11px]" style={{ color: selected ? color : '#CCFF00' }}>
    ...
    <button
      ...
      className={`px-3 py-1.5 rounded-lg border font-display font-bold text-xs uppercase tracking-wide transition-all ${
        selected
          ...
          : 'border-[rgba(255,255,255,0.08)] text-[#888888] hover:border-[rgba(204,255,0,0.35)] hover:text-[#F2F2F2]'
      }`}
    >
      ...
      {open && (
        <>
          ...
          >
            ...
            >
              <div className="bg-[#141414] border border-[rgba(255,255,255,0.1)] rounded-2xl shadow-[0_24px_80px_rgba(12,12,12,0.8)] flex flex-col overflow-hidden">

                {/* Top strip + progress */}
                <div className="flex-shrink-0">
                  <div className="h-1 bg-[rgba(255,255,255,0.06)] relative">
                    <motion.div
                      className="absolute inset-y-0 left-0 bg-gradient-to-r from-[#CCFF00] to-[#6EE07A]"
                  ...
                  <div className="flex items-start justify-between px-7 pt-5 pb-4">
                    <div>
                      ...
                      <h2 className="heading-gradient font-display font-black text-[#F2F2F2] uppercase text-2xl leading-none tracking-tight">
                    ...
                    {step !== 3 && (
                      <button
                        onClick={close}
                        className="w-8 h-8 rounded-lg flex items-center justify-center text-[#888888] hover:text-[#FCA5A5] hover:bg-[rgba(252,165,165,0.08)] transition-all mt-0.5"
                        aria-label="Close"
                      >
                        <X size={18} />
                      </button>
                    ...
                    >
                      ...
                      <div>
                        ...
                        <div className="relative mt-1">
                          <User size={15} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-[#CCFF00] pointer-events-none z-10" />
                          <input
                            ref={nameRef}
                            id="reg-name"
                            type="text"
                      ...
                      <div>
                        ...
                        <div className="relative mt-1">
                          <Mail size={15} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-[#CCFF00] pointer-events-none z-10" />
                          <input
                            id="reg-email"
                            type="email"
                            value={email}
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div>
                          ...
                          <div className="relative mt-1">
                            <Phone size={15} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-[#CCFF00] pointer-events-none z-10" />
                            <input
                              id="reg-phone"
                              type="tel"
                              value={phone}
                        ...
                        <div>
                          ...
                          <div className="relative mt-1">
                            <MapPin size={15} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-[#CCFF00] pointer-events-none z-10" />
                            <select
                              id="reg-city"
                              value={city}
                      ...
                      {role === 'organiser' && (
                        <div>
                          ...
                          <div className="relative mt-1">
                            <Building2 size={15} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-[#CCFF00] pointer-events-none z-10" />
                            <input
                              id="reg-org"
                              type="text"
                              value={orgName}
                      ...
                      <div>
                        ...
                        <div className="relative mt-1">
                          <Lock size={15} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-[#CCFF00] pointer-events-none z-10" />
                          <input
                            id="reg-pass"
                    ...
                    >
                      ...
                      <div>
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <span className="font-mono text-[#CCFF00] text-[10px] tracking-wide">
                        ...
                        <div className="grid grid-cols-2 gap-2">
                          {CAUSES.map(c => (
                            ...
                            >
                              ...
                              {c.label}
                              {causes.includes(c.id) && <CheckCircle size={11} className="ml-auto text-[#CCFF00]" />}
                            </button>
                          ))}
                        </div>
                      </div>
                  ...
                  {step === 3 && (
                    ...
                    >
                      <motion.div
                        ...
                        style={{
                          background: 'radial-gradient(circle, #6EE07A, #CCFF00)',
                          boxShadow: '0 0 40px rgba(110,224,122,0.4)',
                        }}
                      >
                        <CheckCircle size={36} className="text-[#0C0C0C]" />
                      </motion.div>

                      <h3 className="heading-gradient font-display font-black text-[#F2F2F2] text-2xl uppercase tracking-wide mb-2">
                        You're in!
                      </h3>
                      <p className="font-sans text-[#888888] text-sm leading-relaxed max-w-xs mx-auto mb-1">
                        Welcome to Pruthwee, <span className="text-[#CCFF00] font-medium">{name.split(' ')[0]}</span>.
                        {role === 'volunteer'
                ...
                {/* Footer actions */}
                {step !== 3 && (
                  <div className="flex-shrink-0 px-7 pb-6 pt-3 border-t border-[rgba(204,255,0,0.1)] space-y-3">
                    <button
                      type="button"
                      onClick={handleNext}
                      disabled={loading}
