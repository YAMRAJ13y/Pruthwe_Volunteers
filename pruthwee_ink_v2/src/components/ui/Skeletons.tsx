  ...
  return (
    <div className="bg-[#141414] border border-[rgba(204,255,0,0.1)] rounded-2xl overflow-hidden">
      ...
      <div className="p-5 space-y-3">
        ...
        <div className="pt-2 border-t border-[rgba(204,255,0,0.08)] flex justify-between items-center">
...
export function EventsPageSkeleton() {
  return (
    <div className="bg-[#0C0C0C] min-h-screen">
      {/* Hero bar */}
      <div className="bg-[#141414] border-b border-[rgba(204,255,0,0.1)] py-12 px-5 md:px-10">
      ...
      <div className="max-w-7xl mx-auto px-5 md:px-10 py-10">
        ...
        {/* Divider */}
        <div className="my-10 border-t border-[rgba(204,255,0,0.08)]" />
...
function StatCardSk() {
  return (
    <div className="bg-[#141414] border border-[rgba(204,255,0,0.1)] rounded-2xl p-5 space-y-3">
...
function AssignmentCardSk() {
  return (
    <div className="bg-[#141414] border border-[rgba(204,255,0,0.1)] rounded-2xl overflow-hidden flex">
...
export function DashboardSkeleton() {
  return (
    <div className="bg-[#0C0C0C] min-h-screen">
      {/* Header band */}
      <div className="bg-[#02294D] border-b border-[rgba(204,255,0,0.1)] px-5 md:px-10 py-8">
...
function FeaturedArticleSk() {
  return (
    <div className="bg-[#141414] border border-[rgba(255,255,255,0.08)] rounded-2xl overflow-hidden lg:flex">
...
export function NewsPageSkeleton() {
  return (
    <div className="bg-[#0C0C0C] min-h-screen">
      {/* Hero */}
      <div className="bg-[#141414] border-b border-[rgba(204,255,0,0.1)] py-14 px-5 md:px-10">
      ...
      <div className="max-w-6xl mx-auto px-5 md:px-10 py-10">
        ...
        {/* Newsletter band */}
        <div className="mt-12 bg-[#141414] border border-[rgba(204,255,0,0.1)] rounded-2xl p-8 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="space-y-2 flex-1">
      ...
      <div className="max-w-7xl mx-auto px-5 md:px-10 py-10">
        <div className="grid lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            {/* Tabs */}
            <div className="flex gap-2 border-b border-[rgba(204,255,0,0.1)] pb-0">
              {[80, 90, 75, 85].map((w, i) => (
          ...
          {/* Sidebar */}
          <div className="space-y-5">
            <div className="bg-[#141414] border border-[rgba(255,255,255,0.08)] rounded-2xl p-6 space-y-4">
              <div className="flex justify-between">
                <Sk className="h-4 w-24" />
