...
export default function EventDetailPage() {
  ...
  if (!event) {
    return (
      <div className="bg-[#011C40] min-h-screen flex items-center justify-center px-5">
        <div className="text-center">
          <h1 className="font-display font-black text-[#F0FAFB] text-2xl uppercase tracking-wide mb-3">Event not found</h1>
          <p className="font-sans text-[#8BBFCC] text-sm mb-5">This event link is invalid or no longer available.</p>
  ...
  return (
    <div className="bg-[#011C40] min-h-screen">
      ...
      <section className="relative h-[50vh] md:h-[60vh] overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-[#011C40]/60 to-transparent" />
        ...
        <div className="absolute top-6 right-6 flex gap-2">
          <button
            ...
            className={`w-10 h-10 rounded-lg flex items-center justify-center backdrop-blur-sm border transition-all ${
              wishlist
                ...
                : 'bg-[rgba(1,28,64,0.7)] border-[rgba(84,172,191,0.2)] text-[#8BBFCC] hover:text-[#FCA5A5]'
            }`}
          >
          ...
          <button
            onClick={handleShare}
            className="w-10 h-10 rounded-lg flex items-center justify-center bg-[rgba(1,28,64,0.7)] backdrop-blur-sm border border-[rgba(84,172,191,0.2)] text-[#8BBFCC] hover:text-[#A7EBF2] transition-all"
          >
            <Share2 size={16} />
          </button>
        </div>
      ...
      <div className="bg-[#023859] border-b border-[rgba(84,172,191,0.12)]">
        <div className="max-w-7xl mx-auto px-5 md:px-10 py-4">
          <div className="flex flex-wrap items-center gap-5 md:gap-8">
            ...
            <div className="flex items-center gap-2 text-[#8BBFCC] text-sm font-sans">
              <Clock size={15} className="text-[#54ACBF]" />
            ...
            <div className="flex items-center gap-2 ml-auto">
              <Users size={15} className="text-[#54ACBF]" />
              <span
              ...
              <span className="font-mono text-[#54ACBF] text-[10px]">/ {event.capacity}</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-5 md:px-10 py-10">
        <div className="grid lg:grid-cols-[1fr_360px] gap-10">
          ...
          <div>
            ...
            {/* Photo gallery */}
            <div className="mt-10">
              <h3 className="font-display font-black text-[#F0FAFB] text-lg uppercase tracking-wide mb-4">
                Event Photos
              </h3>
            ...
            {/* Organiser info */}
            <div className="mt-10 bg-[rgba(2,56,89,0.4)] border border-[rgba(84,172,191,0.12)] rounded-2xl p-6">
              <h3 className="font-display font-black text-[#F0FAFB] text-base uppercase tracking-wide mb-4">
                About the Organiser
              </h3>
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#54ACBF] to-[#26658C] flex items-center justify-center flex-shrink-0">
                  <span className="font-display font-black text-[#011C40] text-lg">
                    {event.org.name.charAt(0)}
                  </span>
                </div>
                <div>
                  <div className="font-display font-black text-[#F0FAFB] text-base uppercase tracking-wide">
                    {event.org.name}
                  </div>
                  <div className="font-sans text-[#54ACBF] text-sm">{event.org.city}</div>
                </div>
              </div>
            </div>
            ...
            {/* Related events */}
            <div className="mt-10">
              <h3 className="font-display font-black text-[#F0FAFB] text-lg uppercase tracking-wide mb-5">
                Similar Events
              </h3>
              <div className="grid sm:grid-cols-3 gap-4">
                {relatedEvents.map(ev => (
                  <Link key={ev.id} to={`/events/${ev.id}`} className="block group">
                    <div className="bg-[#023859] border border-[rgba(84,172,191,0.12)] rounded-xl overflow-hidden hover:border-[rgba(84,172,191,0.35)] transition-all hover:-translate-y-1">
                      <div className="relative h-24 overflow-hidden">
                        ...
                        <div className="absolute inset-0 bg-gradient-to-t from-[#023859] to-transparent" />
                      </div>
                      <div className="p-3">
                        <div className="font-display font-black text-[#F0FAFB] text-sm uppercase tracking-wide leading-tight mb-1 group-hover:text-[#A7EBF2] transition-colors">
                          {ev.title}
                        </div>
                        <div className="flex items-center justify-between">
                          <span className="font-sans text-[#8BBFCC] text-xs">{ev.city} · {ev.date}</span>
      ...
      <AnimatePresence>
        {showShareToast && (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            exit={{ opacity: 0, y: 20 }}
            className="fixed bottom-6 right-6 z-50 flex items-center gap-3 px-5 py-3 bg-[#023859] border border-[rgba(84,172,191,0.3)] rounded-xl shadow-card"
          >
            <CheckCircle size={16} className="text-[#6EE07A]" />
            <span className="font-display font-bold text-[#F0FAFB] text-sm uppercase tracking-wide">
              Link Copied!
            </span>
          </motion.div>
        )}
  ...
  return (
    <div>
      ...
      {event.description.split('\n\n').map((para, i) => (
        <p key={i} className="font-sans text-[#8BBFCC] text-sm leading-relaxed mb-4">
          {para}
        </p>
      ))}

      {/* What to bring */}
      <div className="mt-6 bg-[rgba(84,172,191,0.06)] border border-[rgba(84,172,191,0.15)] rounded-xl p-5">
        <div className="flex items-center gap-2 mb-3">
          <Info size={15} className="text-[#54ACBF]" />
          <h4 className="font-display font-black text-[#A7EBF2] text-sm uppercase tracking-wide">
            What's Provided
          </h4>
        </div>
        <ul className="space-y-1.5">
          {['Gloves and safety equipment', 'Collection bags and tools', 'Refreshments throughout the day', 'Volunteer coordinator at each sector', 'Verified hours certificate after the event'].map(item => (
            <li key={item} className="flex items-center gap-2 font-sans text-[#8BBFCC] text-sm">
...
function ScheduleTab({ event }: { event: EventDetailData }) {
  return (
    <div>
      <h3 className="font-display font-black text-[#F0FAFB] text-lg uppercase tracking-wide mb-6">
        Event Day Schedule
      </h3>
      <div className="relative">
        {/* Timeline line */}
        <div className="absolute left-16 top-0 bottom-0 w-px bg-gradient-to-b from-[#54ACBF] via-[rgba(84,172,191,0.3)] to-transparent" />
          ...
          {event.schedule.map((item, i) => (
            <div key={i} className="flex gap-6 items-start">
              ...
              <div className="w-14 flex-shrink-0 text-right">
                <span className="font-display font-black text-[#54ACBF] text-sm uppercase tracking-wide">
                  {item.time}
                </span>
              </div>
              ...
              <div className="relative flex-shrink-0 z-10">
                <div className="w-3 h-3 rounded-full bg-[#54ACBF] mt-1 ring-4 ring-[rgba(84,172,191,0.15)]" />
              </div>

              {/* Content */}
              <div className="flex-1 bg-[rgba(2,56,89,0.4)] border border-[rgba(84,172,191,0.1)] rounded-xl p-4 hover:border-[rgba(84,172,191,0.25)] transition-colors">
                <div className="font-display font-black text-[#F0FAFB] text-sm uppercase tracking-wide">
                  {item.event}
                </div>
                {item.location && (
                  <div className="flex items-center gap-1.5 mt-1 font-sans text-[#8BBFCC] text-xs">
                    <MapPin size={11} className="text-[#54ACBF]" /> {item.location}
                  </div>
                )}
              </div>
            </div>
  ...
  return (
    <div>
      <div className="flex items-center gap-2 mb-6">
        <h3 className="font-display font-black text-[#F0FAFB] text-lg uppercase tracking-wide">
          Volunteer Sectors
        </h3>
      ...
      <div className="space-y-3">
        {event.sectors.map(sector => (
          <div key={sector.id} className="border border-[rgba(84,172,191,0.12)] rounded-xl overflow-hidden">
            <button
              onClick={() => setOpen(open === sector.id ? null : sector.id)}
              className="w-full flex items-center gap-4 px-5 py-4 text-left hover:bg-[rgba(84,172,191,0.05)] transition-colors"
            >
              <div className="w-2 h-2 rounded-full bg-[#54ACBF] flex-shrink-0" />
              <div className="flex-1">
                <div className="font-display font-black text-[#F0FAFB] text-sm uppercase tracking-wide">
                  {sector.name}
                </div>
                <div className="flex items-center gap-1.5 font-sans text-[#8BBFCC] text-xs mt-0.5">
                  <MapPin size={10} className="text-[#54ACBF]" /> {sector.location}
                </div>
              </div>
              <ChevronDown
                size={16}
                className={`text-[#54ACBF] transition-transform duration-200 ${open === sector.id ? 'rotate-180' : ''}`}
              />
            </button>
                  ...
                  <div className="px-5 pb-5 border-t border-[rgba(84,172,191,0.1)]">
                    {sector.tasks.map(task => (
                      <div key={task.id} className="mt-4">
                        <div className="font-display font-bold text-[#A7EBF2] text-xs uppercase tracking-[2px] mb-2">
                          Task: {task.name}
                        </div>
                        <div className="space-y-2">
                          {task.assignments.map(a => (
                            <div key={a.id} className="flex items-center justify-between bg-[rgba(1,28,64,0.5)] rounded-lg px-4 py-2.5">
                              ...
                              <div className="flex items-center gap-2">
                                <span className="font-sans text-[#8BBFCC] text-xs">{a.location}</span>
...
function LocationTab({ event }: { event: EventDetailData }) {
  return (
    <div>
      ...
      <div className="bg-[rgba(2,56,89,0.4)] border border-[rgba(84,172,191,0.12)] rounded-xl p-5 mb-5">
        <div className="flex items-start gap-3">
          <MapPin size={18} className="text-[#54ACBF] flex-shrink-0 mt-0.5" />
          <div>
            <div className="font-display font-black text-[#F0FAFB] text-base uppercase tracking-wide">
              {event.venue_name}
            </div>
            <div className="font-sans text-[#8BBFCC] text-sm mt-1">{event.venue_address}</div>
            <a
              href={event.maps_link}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-1.5 mt-3 font-display font-bold text-[#54ACBF] text-xs uppercase tracking-wide hover:text-[#A7EBF2] transition-colors"
            >
      ...
      {/* Map placeholder */}
      <div className="rounded-xl overflow-hidden border border-[rgba(84,172,191,0.12)] h-64 bg-[rgba(2,56,89,0.4)] flex items-center justify-center">
        <div className="text-center">
          <MapPin size={32} className="text-[#54ACBF] mx-auto mb-2" />
          <p className="font-display font-bold text-[#8BBFCC] text-sm uppercase tracking-wide">
            {event.venue_name}
          </p>
          <a
            href={event.maps_link}
      ...
      {/* Assembly point */}
      <div className="mt-4 flex items-start gap-3 bg-[rgba(84,172,191,0.06)] border border-[rgba(84,172,191,0.15)] rounded-xl p-4">
        ...
        <div>
          ...
          <p className="font-sans text-[#8BBFCC] text-sm mt-0.5">
...
function RegistrationSidebar(props: RegistrationSidebarProps) {
  ...
  return (
    <div className="bg-[#023859] border border-[rgba(84,172,191,0.2)] rounded-2xl overflow-hidden">
      {/* Header */}
      <div className="p-5 border-b border-[rgba(84,172,191,0.12)]">
        ...
        <div className="flex justify-between mt-1">
          <span className="font-mono text-[#54ACBF] text-[9px]">{fillPct}% filled</span>
          <span className="font-mono text-[#54ACBF] text-[9px]">{event.capacity} total</span>
        </div>
      </div>
      ...
      <div className="p-5 space-y-5">
        ...
        <div>
          <label className="label">
            Sector Preferences
            <span className="font-mono text-[#54ACBF] text-[9px] normal-case ml-2">
              (choose up to 3)
            </span>
          </label>
          <div className="space-y-2">
              ...
              <button
                ...
                className={`w-full flex items-center justify-between px-3 py-2.5 rounded-lg border transition-all duration-150 ${
                  sectorPriority.includes(s.id)
                    ...
                    : 'border-[rgba(84,172,191,0.12)] text-[#8BBFCC] hover:border-[rgba(84,172,191,0.35)] disabled:opacity-40'
                }`}
              >
                ...
                {sectorPriority.includes(s.id) && (
                  <span className="font-mono text-[#54ACBF] text-[10px]">
        ...
        <div>
          <button
            ...
            className="flex items-center gap-2 font-display font-bold text-xs uppercase tracking-wide text-[#54ACBF] hover:text-[#A7EBF2] transition-colors"
          >
            <Users size={13} />
        ...
        {!user && (
          <p className="font-sans text-[#8BBFCC] text-xs text-center">
            ...
            <button
              ...
              className="text-[#54ACBF] hover:text-[#A7EBF2] underline"
            >
              Register in 2 mins
            </button>
          </p>
        ...
        <button className="w-full flex items-center justify-center gap-2 py-3 rounded-lg border border-[rgba(84,172,191,0.15)] text-[#8BBFCC] hover:text-[#A7EBF2] hover:border-[rgba(84,172,191,0.35)] font-display font-bold text-xs uppercase tracking-wide transition-all">
