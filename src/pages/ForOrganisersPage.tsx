...
const FEATURES = [
  {
    icon: <Layers size={26} className="text-[#54ACBF]" />,
  ...
  {
    icon: <Zap size={26} className="text-[#54ACBF]" />,
  ...
  {
    icon: <Users size={26} className="text-[#54ACBF]" />,
  ...
  {
    icon: <MessageSquare size={26} className="text-[#54ACBF]" />,
  ...
  {
    icon: <Calendar size={26} className="text-[#54ACBF]" />,
  ...
  {
    icon: <BarChart3 size={26} className="text-[#54ACBF]" />,
  ...
  {
    icon: <Shield size={26} className="text-[#54ACBF]" />,
  ...
  {
    icon: <CheckCircle size={26} className="text-[#54ACBF]" />,
...
function OrgHero() {
  return (
    <section className="relative pt-10 pb-24 overflow-hidden">
      ...
      <div className="absolute top-0 right-1/4 w-96 h-96 bg-[#26658C]/10 rounded-full blur-3xl" />
          ...
          >
            ...
            <div className="grid grid-cols-3 gap-4 mt-10">
              {[
                ...
                <div key={s.label} className="text-center bg-[rgba(2,56,89,0.4)] border border-[rgba(84,172,191,0.12)] rounded-xl py-4">
                  <div className="font-display font-black text-[#A7EBF2] text-2xl leading-none">{s.num}</div>
                  <div className="font-display font-bold text-[#54ACBF] text-[10px] uppercase tracking-[2px] mt-1">{s.label}</div>
                </div>
              ))}
            </div>
          </motion.div>
          ...
          >
            {[
              ...
              <motion.div
                ...
                className="flex items-center gap-4 bg-[rgba(2,56,89,0.4)] border border-[rgba(84,172,191,0.12)] rounded-xl px-4 py-3 hover:border-[rgba(84,172,191,0.3)] transition-colors"
              >
      ...
      <div className="max-w-7xl mx-auto px-5 md:px-10">
        ...
        >
          <motion.div variants={fadeUp} className="text-center mb-16">
            ...
            >
              6 Steps to a{' '}
              <span className="text-[#54ACBF]">Successful Event</span>
            </h2>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {STEPS.map((step, i) => (
              <motion.div
                key={step.step}
                variants={fadeUp}
                className="relative bg-[rgba(1,28,64,0.5)] border border-[rgba(84,172,191,0.12)] rounded-2xl p-6 hover:border-[rgba(84,172,191,0.3)] transition-all duration-200 group"
              >
                {/* Step number */}
                <div className="absolute top-4 right-4 font-display font-black text-[rgba(84,172,191,0.15)] text-5xl leading-none">
                  {step.step}
                </div>
                ...
                <div className="mt-4 h-0.5 bg-gradient-to-r from-[#54ACBF] to-transparent scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left" />
              </motion.div>
            ))}
          </div>
        </motion.div>
      ...
      <div className="max-w-7xl mx-auto px-5 md:px-10">
        ...
        >
          <motion.div variants={fadeUp} className="text-center mb-14">
            ...
            >
              Everything You{' '}
              <span className="text-[#54ACBF]">Need</span>
            </h2>
          </motion.div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {FEATURES.map((f) => (
              <motion.div
                ...
                className="bg-[rgba(2,56,89,0.4)] border border-[rgba(84,172,191,0.12)] rounded-2xl p-5 hover:border-[rgba(84,172,191,0.35)] transition-all duration-200 group"
              >
                <div className="w-11 h-11 rounded-xl bg-[rgba(84,172,191,0.1)] border border-[rgba(84,172,191,0.2)] flex items-center justify-center mb-4 group-hover:bg-[rgba(84,172,191,0.15)] transition-colors">
                  {f.icon}
                </div>
                ...
                <p className="font-sans text-[#8BBFCC] text-sm leading-relaxed">{f.desc}</p>
              </motion.div>
            ))}
          </div>
        </motion.div>
      ...
      <div className="max-w-7xl mx-auto px-5 md:px-10">
        ...
        >
          <motion.div variants={fadeUp} className="text-center mb-14">
            ...
            >
              4 Organiser{' '}
              <span className="text-[#54ACBF]">Roles</span>
            </h2>
          ...
          <motion.div variants={fadeUp} className="flex gap-3 overflow-x-auto pb-4 mb-8 justify-start md:justify-center">
            {ORG_ROLES.map((role, i) => (
              <button
                ...
                style={{
                  borderColor: active === i ? role.color : 'rgba(84,172,191,0.15)',
                  background:  active === i ? role.bg : 'rgba(1,28,64,0.4)',
                  color:       active === i ? role.color : '#8BBFCC',
                }}
              >
                <span>{role.icon}</span>
                {role.role}
          ...
          >
            <div
              className="bg-[rgba(1,28,64,0.6)] border-2 rounded-2xl p-8"
            ...
            >
              ...
              <p className="font-sans text-[#8BBFCC] text-sm leading-relaxed mb-6">
                {ORG_ROLES[active].desc}
              </p>
              <div>
                <p className="font-display font-bold text-[#A7EBF2] text-xs uppercase tracking-[2px] mb-3">
                  Can Do
                </p>
                <ul className="grid grid-cols-2 gap-2">
                  {ORG_ROLES[active].can.map((item) => (
                    <li key={item} className="flex items-center gap-2">
                      ...
                      <span className="font-sans text-[#8BBFCC] text-sm">{item}</span>
                    </li>
                  ))}
                </ul>
              </div>
...
function SectorSystemSection() {
  ...
  const levels = [
    { level: 'L1', name: 'Sector',      example: 'Food & Drinks',       color: '#A7EBF2', desc: 'Top-level department. E.g. Security, Catering, Stage Crew.' },
    { level: 'L2', name: 'Sub-Sector',  example: 'Gate A / Gate B',     color: '#54ACBF', desc: 'Optional sub-group. E.g. North Zone, VIP Area.' },
    { level: 'L3', name: 'Task',        example: 'Entrance Control',     color: '#26658C', desc: 'Specific activity with skill requirements and PDF briefing.' },
    { level: 'L4', name: 'Assignment',  example: 'Mon 08:30–11:30 · 4 volunteers', color: '#023859', desc: 'Actual shift with date, time, location, and volunteer count.' },
  ];
        ...
        >
          <motion.div variants={fadeUp} className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              >
                4-Level Sector{' '}
                <span className="text-[#54ACBF]">Hierarchy</span>
              </h2>
              ...
              <p className="font-sans text-[#8BBFCC] text-base leading-relaxed">
                Two assignment types: <span className="text-[#A7EBF2] font-semibold">Registration</span> (inquiry, shown on registration form)
                and <span className="text-[#A7EBF2] font-semibold">Allocation</span> (actual shift, only visible after organiser activates).
              </p>
            </div>
            ...
            <motion.div variants={fadeUp} className="space-y-3">
              {levels.map((lv, i) => (
                <div
                  key={lv.level}
                  className="flex items-center gap-4 rounded-xl p-4 border border-[rgba(84,172,191,0.12)]"
                  style={{
                    marginLeft: `${i * 16}px`,
      ...
      <div className="max-w-7xl mx-auto px-5 md:px-10">
        ...
        >
          <motion.div variants={fadeUp} className="text-center mb-14">
            ...
            >
              Simple &{' '}
              <span className="text-[#54ACBF]">Fair Pricing</span>
            </h2>
            <p className="font-sans text-[#8BBFCC] max-w-xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <motion.div
              variants={fadeUp}
              className="bg-[rgba(1,28,64,0.6)] border border-[rgba(84,172,191,0.25)] rounded-2xl p-8"
            >
              <div className="font-mono text-[#54ACBF] text-xs tracking-[2px] uppercase mb-2">Standard</div>
              <div className="font-display font-black text-[#F0FAFB] text-4xl uppercase mb-1">
                Base Fee +
              </div>
              <div className="font-display font-black text-[#54ACBF] text-2xl uppercase mb-6">
                Per Volunteer Cost
              </div>
            ...
            <motion.div
              variants={fadeUp}
              className="bg-[rgba(1,28,64,0.4)] border border-[rgba(84,172,191,0.12)] rounded-2xl p-8"
            >
              <div className="font-display font-black text-[#A7EBF2] text-sm uppercase tracking-[2px] mb-5">
                All Plans Include
              </div>
              <ul className="space-y-3">
                {PRICING_FEATURES.map((f) => (
                  <li key={f} className="flex items-center gap-3">
                    <CheckCircle size={15} className="text-[#54ACBF] flex-shrink-0" />
                    <span className="font-sans text-[#8BBFCC] text-sm">{f}</span>
                  </li>
                ))}
              </ul>
            </motion.div>
          ...
          <motion.div
            variants={fadeUp}
            className="mt-8 max-w-4xl mx-auto bg-[rgba(84,172,191,0.06)] border border-[rgba(84,172,191,0.2)] rounded-xl p-5 flex items-start gap-4"
          >
            <span className="text-2xl flex-shrink-0">💡</span>
            <div>
              <p className="font-display font-black text-[#A7EBF2] text-sm uppercase tracking-wide mb-1">
...
function OrgCTASection() {
  return (
    <section className="py-20 bg-[#011C40] border-t border-[rgba(84,172,191,0.12)]">
      <div className="max-w-3xl mx-auto px-5 md:px-10 text-center">
        ...
        >
          Ready to Build{' '}
          <span className="text-[#54ACBF]">Your Event?</span>
        </h2>
        ...
        <div className="mt-12">
          ...
          <div className="flex items-center justify-center gap-6 flex-wrap">
            {['MoEF', 'NITI Aayog', 'NYK', 'MSJE', 'CSR India'].map((p) => (
              <span key={p} className="font-display font-bold text-[#8BBFCC] text-sm uppercase tracking-wider hover:text-[#A7EBF2] transition-colors cursor-default">
                {p}
              </span>
            ))}
          </div>
