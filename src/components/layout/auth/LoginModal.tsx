...
function Backdrop({ onClick }: { onClick: () => void }) {
  return (
    <motion.div
      className="fixed inset-0 z-[150] bg-[#011C40]/80 backdrop-blur-sm"
      ...
      {open && (
        <>
          ...
          >
            ...
            >
              {/* Card */}
              <div className="bg-[#023859] border border-[rgba(84,172,191,0.2)] rounded-2xl shadow-[0_24px_80px_rgba(1,28,64,0.8)] overflow-hidden">

                {/* Top colour strip */}
                <div className="h-1 bg-gradient-to-r from-[#54ACBF] via-[#A7EBF2] to-[#54ACBF]" />
                ...
                <div className="flex items-start justify-between px-7 pt-6 pb-0">
                  <div>
                    ...
                    <h2 className="font-display font-black text-[#F0FAFB] uppercase text-3xl leading-none tracking-tight">
                      Sign In
                    </h2>
                  ...
                  <button
                    onClick={close}
                    className="w-8 h-8 rounded-lg flex items-center justify-center text-[#8BBFCC] hover:text-[#FCA5A5] hover:bg-[rgba(252,165,165,0.08)] transition-all mt-1 flex-shrink-0"
                    aria-label="Close"
                  >
                    <X size={18} />
                  </button>
                ...
                <form onSubmit={handleSubmit} className="px-7 py-6 space-y-4">
                  ...
                  <div>
                    ...
                    <div className="relative mt-1">
                      <Mail size={15} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-[#54ACBF] pointer-events-none" />
                      <input
                        ref={emailRef}
                        id="login-email"
                        type="email"
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-1">
                      ...
                      <button
                        type="button"
                        className="font-sans text-[#54ACBF] text-xs hover:text-[#A7EBF2] transition-colors"
                      >
                        Forgot password?
                      </button>
                    </div>
                    <div className="relative">
                      <Lock size={15} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-[#54ACBF] pointer-events-none" />
                      <input
                        id="login-password"
                ...
                <div className="px-7 pb-6">
                  <div className="border-t border-[rgba(84,172,191,0.1)] pt-5">
                    <p className="font-mono text-[#54ACBF] text-[10px] uppercase tracking-[2.5px] mb-3 text-center">
                      Demo Accounts
                    </p>
                    <div className="grid grid-cols-3 gap-2">
                      {([
                        { role: 'volunteer' as const,  label: 'Volunteer', color: '#6EE07A' },
                        { role: 'organiser' as const,  label: 'Organiser', color: '#A7EBF2' },
                    ...
                    <p className="font-sans text-[#54ACBF] text-[11px] text-center mt-2 opacity-70">
